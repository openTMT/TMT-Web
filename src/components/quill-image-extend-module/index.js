...
export class ImageExtend {
    ...
    insertImg() {
        ...
        self.cursorIndex=self.quill.selection.savedRange.index
        self.quill.insertEmbed(self.cursorIndex , 'image', self.imgURL)
        self.quill.update()
    ...
    uploading() {
      ...
      // console.log(QuillWatch.active.quill.getSelection())
      // console.log(QuillWatch.active.quill.getLength())
